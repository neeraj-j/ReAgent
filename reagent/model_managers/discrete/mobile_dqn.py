...
from reagent.net_builder.discrete_dqn.mob_net import MobNet
...
@dataclass
class MobileDQN(DiscreteDQNBase):
    __hash__ = param_hash
    ...
    net_builder: DiscreteDQNNetBuilder__Union = field(
        ...
        default_factory=lambda: DiscreteDQNNetBuilder__Union(MobNet=MobNet())
    )
    ...
    def __post_init_post_parse__(self):
        ...
        self.trainer_param = DQNTrainerParameters(actions=['0', '1'])
        assert (
    ...
    def build_trainer(
        ...
        q_network_target = deepcopy(q_network)
        ...
        if self.eval_parameters.calc_cpe_in_training:
            ...
            q_network_cpe_target = deepcopy(q_network_cpe)
